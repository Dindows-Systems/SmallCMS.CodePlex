...
namespace CMS
{
    ...
    public class XmlRoleProvider : RoleProvider
    {
        ...
        readonly string[] _DefaultRolesToAdd = new string[] { Website.Properties.Settings.Default.CMS_Role };
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (String.IsNullOrEmpty(path))
                path = Website.Properties.Settings.Default.CMS_StorageLocation + "roles.xml";
            ...
            if (!RoleExists(Website.Properties.Settings.Default.CMS_Role))
                AddUsersToRoles(_UserNames.ToArray(), _DefaultRolesToAdd);
                ...
                foreach (Role role in _Roles)
                {
                    foreach (string _name in roleNames)
                    {
                        if (role.Name.Equals(_name, StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            {
                                if (role.Name.Equals(Website.Properties.Settings.Default.CMS_Role, StringComparison.OrdinalIgnoreCase))
                                {
        ...
        {
            if (!roleName.Equals(Website.Properties.Settings.Default.CMS_Role, StringComparison.OrdinalIgnoreCase))
            {
        ...
        private void ReadMembershipDataStore()
        {
            string fullyQualifiedPath = VirtualPathUtility.Combine
              (VirtualPathUtility.AppendTrailingSlash
              (HttpRuntime.AppDomainAppVirtualPath), Website.Properties.Settings.Default.CMS_StorageLocation + "users.xml");
